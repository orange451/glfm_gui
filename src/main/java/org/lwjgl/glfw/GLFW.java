...
public class GLFW {
    ...
    /*public static PointerBuffer glfwGetMonitors() {
    	long[] dat = Glfm.glfwGetMonitors();
    	
    }
    
    public static Buffer<GLFWVideoMode> glfwGetVideoModes(long monitor) {
    	List<GlfmVideoMode> dat = Glfm.glfwGetVideoModes(monitor);
    }*/
    ...
    public static boolean glfwExtensionSupported(String extension) {
    	return Glfm.glfmExtensionSupported(extension);
    }
	...
	public static void glfwGetFramebufferSize(long windowId, int[] x, int[] y) {
		x[0] = Glfm.glfmGetDisplayWidth(windowId);
		y[0] = Glfm.glfmGetDisplayHeight(windowId);
	}
	
	public static void glfwGetFramebufferSize(long windowId, IntBuffer x, IntBuffer y) {
		x.put(Glfm.glfmGetDisplayWidth(windowId));
		y.put(Glfm.glfmGetDisplayHeight(windowId));
	}
	
	public static void glfwGetWindowSize(long windowId, int[] x, int[] y) {
		x[0] = (int) (Glfm.glfmGetDisplayWidth(windowId) / Glfm.glfmGetDisplayScale(windowId));
		y[0] = (int) (Glfm.glfmGetDisplayHeight(windowId) / Glfm.glfmGetDisplayScale(windowId));
	}
	
	public static void glfwGetWindowSize(long windowId, IntBuffer x, IntBuffer y) {
		x.put((int) (Glfm.glfmGetDisplayWidth(windowId) / Glfm.glfmGetDisplayScale(windowId)));
		y.put((int) (Glfm.glfmGetDisplayHeight(windowId) / Glfm.glfmGetDisplayScale(windowId)));
	}
	...
	public static void glfwSetClipboardString(long id, String text) {
		Glfm.glfmSetClipBoardContent(text);
	}

	public static String glfwGetClipboardString(long id) {
		return Glfm.glfmGetClipBoardContent();
	}
